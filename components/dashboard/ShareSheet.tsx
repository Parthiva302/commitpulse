  ...
  const options = [
    {
      key: 'copy',
      icon: Link2,
      label: t('dashboard.share.copy_link'),
      description: t('dashboard.share.copy_link_desc'),
    ...
    },
    {
      key: 'twitter',
      icon: XBrandIcon,
      label: t('dashboard.share.share_x'),
      description: t('dashboard.share.share_x_desc'),
    ...
    },
    {
      key: 'linkedin',
      icon: LinkedInIcon,
      label: t('dashboard.share.share_linkedin'),
      description: t('dashboard.share.share_linkedin_desc'),
...

    {
      key: 'markdown',
      icon: Code,
      label: t('dashboard.share.copy_markdown'),
      description: t('dashboard.share.copy_markdown_desc'),
      gradient: 'bg-zinc-800',
      glow: 'transparent',
    ...
    },
    {
      ...
      description: t('dashboard.share.download_png_desc'),
      gradient: 'bg-zinc-800',
      glow: 'transparent',
    ...
    },
    {
      ...
      description: t('dashboard.share.download_svg_desc'),
      gradient: 'bg-zinc-800',
      glow: 'transparent',
    ...
    },
    {
      ...
      description: t('dashboard.share.download_json_desc'),
      gradient: 'bg-zinc-800',
      glow: 'transparent',
    ...
    },
    {
      ...
      label:
        typeof window !== 'undefined' && 'share' in navigator
          ? t('dashboard.share.share_os')
          : t('dashboard.share.share_os_fallback'),
      description:
        typeof window !== 'undefined' && 'share' in navigator
          ? t('dashboard.share.share_os_desc')
          : t('dashboard.share.share_os_fallback_desc'),
      gradient: 'bg-zinc-800',
      glow: 'transparent',
    ...
    {
      key: 'reddit',
      label: t('dashboard.share.share_reddit'),
      description: t('dashboard.share.share_reddit_desc'),
      icon: RedditIcon,
      action: handleReddit,
                      ...
                      >
                        ...
                        <div className="flex flex-col min-w-0">
                          <span className="text-sm text-zinc-850 dark:text-white font-medium leading-tight">
                            {state === 'success'
                              ? opt.key === 'copy'
                                ? t('dashboard.share.link_copied')
                                : opt.key === 'png'
                                  ? t('dashboard.share.downloaded')
                                  : opt.key === 'json'
                                    ? t('dashboard.share.json_downloaded')
                                    : opt.key === 'svg'
                                      ? t('dashboard.share.svg_downloaded')
                                      : opt.label
                              : state === 'error'
                                ? t('dashboard.share.failed')
                                : opt.label}
                          </span>
